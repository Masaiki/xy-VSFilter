...
#else
#define XY_VSFILTER_VERSION_STR      XY_VAR_2_STR2(XY_VSFILTER_VERSION_MAJOR) "," XY_VAR_2_STR2(XY_VSFILTER_VERSION_MINOR) "," XY_VAR_2_STR2(XY_VSFILTER_VERSION_PATCH) "," XY_VAR_2_STR2(XY_VSFILTER_VERSION_COMMIT) " (built on " BUILD_DATE_STRING " with libass " LIBASS_VERSION_STRING ")"
#define XY_ABOUT_VERSION_STR         XY_VAR_2_STR2(XY_VSFILTER_VERSION_MAJOR) "." XY_VAR_2_STR2(XY_VSFILTER_VERSION_MINOR) "." XY_VAR_2_STR2(XY_VSFILTER_VERSION_PATCH) "." XY_VAR_2_STR2(XY_VSFILTER_VERSION_COMMIT) " (built on " BUILD_DATE_STRING " with libass " LIBASS_VERSION_STRING ")"
#endif
