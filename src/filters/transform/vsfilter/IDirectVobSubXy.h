...
namespace DirectVobSubXyOptions
{
    enum
    {
        ...
        STRING_FILE_NAME,
        STRING_CSRI_LIB_PATH, // path to csri renderer dll
        ...
        INT_TEXT_RENDERER_MODE,
        INT_VSFILTER_COMPATIBILITY_MODE,
        INT_LIBASS_HINTING_MODE,

        DOUBLE_LIBASS_FONT_SCALE,
        DOUBLE_LIBASS_LINE_SPACING,
        DOUBLE_LIBASS_LINE_POSITION,
        INT_LIBASS_SHAPER,
        INT_LIBASS_STYLE_OVERRIDE,
        BOOL_LIBASS_SCALE_SIGNS,
        BOOL_LIBASS_JUSTIFY,
        STRING_LIBASS_STYLE_OVERRIDES,
        STRING_LIBASS_STYLES_FILE,
        STRING_LIBASS_FONTS_DIR,
        BOOL_LIBASS_USE_EMBEDDED_FONTS,
        DOUBLE_LIBASS_PRUNE_DELAY,
        INT_LIBASS_GLYPH_CACHE_LIMIT,
        INT_LIBASS_BITMAP_CACHE_MAX_SIZE,
    ...
    const XyOptionsImpl::Option DirectVobFilterOptions[] = {
        ...
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_TEXT_RENDERER_MODE},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_VSFILTER_COMPATIBILITY_MODE},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_LIBASS_HINTING_MODE},

        {XyOptionsImpl::OPTION_TYPE_DOUBLE, XyOptionsImpl::OPTION_MODE_RW, DOUBLE_LIBASS_FONT_SCALE},
        {XyOptionsImpl::OPTION_TYPE_DOUBLE, XyOptionsImpl::OPTION_MODE_RW, DOUBLE_LIBASS_LINE_SPACING},
        {XyOptionsImpl::OPTION_TYPE_DOUBLE, XyOptionsImpl::OPTION_MODE_RW, DOUBLE_LIBASS_LINE_POSITION},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_LIBASS_SHAPER},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_LIBASS_STYLE_OVERRIDE},
        {XyOptionsImpl::OPTION_TYPE_BOOL  , XyOptionsImpl::OPTION_MODE_RW, BOOL_LIBASS_SCALE_SIGNS},
        {XyOptionsImpl::OPTION_TYPE_BOOL  , XyOptionsImpl::OPTION_MODE_RW, BOOL_LIBASS_JUSTIFY},
        {XyOptionsImpl::OPTION_TYPE_STRING, XyOptionsImpl::OPTION_MODE_RW, STRING_LIBASS_STYLE_OVERRIDES},
        {XyOptionsImpl::OPTION_TYPE_STRING, XyOptionsImpl::OPTION_MODE_RW, STRING_LIBASS_STYLES_FILE},
        {XyOptionsImpl::OPTION_TYPE_STRING, XyOptionsImpl::OPTION_MODE_RW, STRING_LIBASS_FONTS_DIR},
        {XyOptionsImpl::OPTION_TYPE_BOOL  , XyOptionsImpl::OPTION_MODE_RW, BOOL_LIBASS_USE_EMBEDDED_FONTS},
        {XyOptionsImpl::OPTION_TYPE_DOUBLE, XyOptionsImpl::OPTION_MODE_RW, DOUBLE_LIBASS_PRUNE_DELAY},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_LIBASS_GLYPH_CACHE_LIMIT},
        {XyOptionsImpl::OPTION_TYPE_INT   , XyOptionsImpl::OPTION_MODE_RW, INT_LIBASS_BITMAP_CACHE_MAX_SIZE},
        ...
        {XyOptionsImpl::OPTION_TYPE_STRING, XyOptionsImpl::OPTION_MODE_RW, STRING_CSRI_LIB_PATH},
